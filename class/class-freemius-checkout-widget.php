...
class Freemius_Checkout_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		?>
		<p>
			<label for="<?php echo $this->get_field_name( 'title' ); ?>"> <?php esc_attr_e( 'Title:', 'checkout-freemius-rewamped' ); ?>
			</label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>"
			       name="<?php echo $this->get_field_name( 'title' ); ?>" type="text"
			       value="<?php echo $instance['title']; ?>"/>
		</p>
			<label for="<?php echo $this->get_field_name( 'description' ); ?>"> <?php esc_attr_e( 'Description:', 'checkout-freemius-rewamped' ); ?>
			</label>
...
<script>
            var handler = FS.Checkout.configure({
                plugin_id:  '<?php echo $instance['plugin_id']; ?>',
                plan_id:    '<?php echo $instance['plan_id']; ?>',
                public_key: '<?php echo $instance['public_key']; ?>',
                image:      '<?php echo $instance['image']; ?>'
            });
...
<?php
	...
	public function freemius_load_script() {
		wp_register_script( 'FreemiusJS', 'https://checkout.freemius.com/checkout.min.js', array( 'jquery' ) );
	}
}
