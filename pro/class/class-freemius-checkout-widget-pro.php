...
class Freemius_Checkout_Widget_Pro extends WP_Widget {
	public function __construct() {
		$widget_args = array(
			...
			'description' => __( 'Display your latest products', TEXTDOMAINPRO ),
		);
		parent::__construct(
	...
	public function form( $instance ) {
		?>
		<p>
			<label for="<?php echo esc_html( $this->get_field_name( 'title' ) ); ?>"> <?php esc_attr_e( 'Title:', TEXTDOMAINPRO ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_name( 'number' ); ?>"> <?php esc_attr_e( 'number:', TEXTDOMAINPRO ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_name( 'thumbnail' ); ?>"> <?php esc_attr_e( 'Display Thumbnail:', TEXTDOMAINPRO ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_name( 'button' ); ?>"> <?php esc_attr_e( 'Display buy button:', TEXTDOMAINPRO ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_name( 'excerpt' ); ?>"> <?php esc_attr_e( 'Display the Excerpt:', TEXTDOMAINPRO ); ?>
			</label>
