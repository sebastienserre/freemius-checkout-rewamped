...
class Freemius_Checkout_Widget_Pro extends WP_Widget {
	public function __construct() {
		$widget_args = array(
			...
			'description' => __( 'Display your latest products', 'simple-freemius-shop' ),
		);
		parent::__construct(
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_name( 'number' ); ?>"> <?php esc_attr_e( 'number:', 'simple-freemius-shop' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_name( 'thumbnail' ); ?>"> <?php esc_attr_e( 'Display Thumbnail:', 'simple-freemius-shop' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_name( 'button' ); ?>"> <?php esc_attr_e( 'Display buy button:', 'simple-freemius-shop' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_name( 'excerpt' ); ?>"> <?php esc_attr_e( 'Display the Excerpt:', 'simple-freemius-shop' ); ?>
			</label>
			...
			if ( have_rows( 'freemius_checkout_plans', $product->ID ) ) { // flexible
				while ( have_rows( 'freemius_checkout_plans', $product->ID ) ) { //flexible
					...
					if ( 'freemius_checkout_add_new_plans' === get_row_layout() ) {
						...
						<button id="purchase"
						        class="purchase"><?php printf( esc_html__( 'From %s $', 'simple-freemius-shop' ), $price ); ?></button>
